...
const (
	...
	CommandSubscribe_Pop        CommandSubscribe_SubType = 4
)
...
type CommandPopResponse_ResultCode int32

const (
	CommandPopResponse_HAS_MESSAGE CommandPopResponse_ResultCode = 1
	CommandPopResponse_NO_MESSAGE  CommandPopResponse_ResultCode = 2
)

var CommandPopResponse_ResultCode_name = map[int32]string{
	1: "HAS_MESSAGE",
	2: "NO_MESSAGE",
}

var CommandPopResponse_ResultCode_value = map[string]int32{
	"HAS_MESSAGE": 1,
	"NO_MESSAGE":  2,
}

func (x CommandPopResponse_ResultCode) Enum() *CommandPopResponse_ResultCode {
	p := new(CommandPopResponse_ResultCode)
	*p = x
	return p
}

func (x CommandPopResponse_ResultCode) String() string {
	return proto.EnumName(CommandPopResponse_ResultCode_name, int32(x))
}

func (x *CommandPopResponse_ResultCode) UnmarshalJSON(data []byte) error {
	value, err := proto.UnmarshalJSONEnum(CommandPopResponse_ResultCode_value, data, "CommandPopResponse_ResultCode")
	if err != nil {
		return err
	}
	*x = CommandPopResponse_ResultCode(value)
	return nil
}

func (CommandPopResponse_ResultCode) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_39529ba7ad9caeb8, []int{67, 0}
}
...
const (
	...
	BaseCommand_POP_REQUEST                      BaseCommand_Type = 198
	BaseCommand_POP_RESPONSE                     BaseCommand_Type = 199
)
...
func (BaseCommand_Type) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_39529ba7ad9caeb8, []int{68, 0}
}
...
type CommandPopRequest struct {
	ConsumerId           *uint64  `protobuf:"varint,1,req,name=consumer_id,json=consumerId" json:"consumer_id,omitempty"`
	PopNum               *uint32  `protobuf:"varint,2,req,name=popNum" json:"popNum,omitempty"`
	InvisibleTime        *uint64  `protobuf:"varint,3,opt,name=invisibleTime" json:"invisibleTime,omitempty"`
	PopStartTime         *uint64  `protobuf:"varint,4,req,name=popStartTime" json:"popStartTime,omitempty"`
	IsHold               *bool    `protobuf:"varint,5,req,name=isHold" json:"isHold,omitempty"`
	PopTimeout           *uint32  `protobuf:"varint,6,req,name=popTimeout" json:"popTimeout,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}

func (m *CommandPopRequest) Reset()         { *m = CommandPopRequest{} }
func (m *CommandPopRequest) String() string { return proto.CompactTextString(m) }
func (*CommandPopRequest) ProtoMessage()    {}
func (*CommandPopRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_39529ba7ad9caeb8, []int{66}
}
func (m *CommandPopRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *CommandPopRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_CommandPopRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *CommandPopRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_CommandPopRequest.Merge(m, src)
}
func (m *CommandPopRequest) XXX_Size() int {
	return m.Size()
}
func (m *CommandPopRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_CommandPopRequest.DiscardUnknown(m)
}

var xxx_messageInfo_CommandPopRequest proto.InternalMessageInfo

func (m *CommandPopRequest) GetConsumerId() uint64 {
	if m != nil && m.ConsumerId != nil {
		return *m.ConsumerId
	}
	return 0
...
func (m *CommandPopRequest) GetPopNum() uint32 {
	if m != nil && m.PopNum != nil {
		return *m.PopNum
	}
	return 0
}

func (m *CommandPopRequest) GetInvisibleTime() uint64 {
	if m != nil && m.InvisibleTime != nil {
		return *m.InvisibleTime
	}
	return 0
}

func (m *CommandPopRequest) GetPopStartTime() uint64 {
	if m != nil && m.PopStartTime != nil {
		return *m.PopStartTime
	}
	return 0
}

func (m *CommandPopRequest) GetIsHold() bool {
	if m != nil && m.IsHold != nil {
		return *m.IsHold
	}
	return false
}

func (m *CommandPopRequest) GetPopTimeout() uint32 {
	if m != nil && m.PopTimeout != nil {
		return *m.PopTimeout
	}
	return 0
}

type CommandPopResponse struct {
	ConsumerId           *uint64                        `protobuf:"varint,1,req,name=consumer_id,json=consumerId" json:"consumer_id,omitempty"`
	RestNum              *uint64                        `protobuf:"varint,2,req,name=restNum" json:"restNum,omitempty"`
	ResultCode           *CommandPopResponse_ResultCode `protobuf:"varint,3,req,name=resultCode,enum=pulsar.proto.CommandPopResponse_ResultCode" json:"resultCode,omitempty"`
	Message              []*CommandMessage              `protobuf:"bytes,4,rep,name=message" json:"message,omitempty"`
	Payload              [][]byte                       `protobuf:"bytes,5,rep,name=payload" json:"payload,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                       `json:"-"`
	XXX_unrecognized     []byte                         `json:"-"`
	XXX_sizecache        int32                          `json:"-"`
}

func (m *CommandPopResponse) Reset()         { *m = CommandPopResponse{} }
func (m *CommandPopResponse) String() string { return proto.CompactTextString(m) }
func (*CommandPopResponse) ProtoMessage()    {}
func (*CommandPopResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_39529ba7ad9caeb8, []int{67}
}
func (m *CommandPopResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *CommandPopResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_CommandPopResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *CommandPopResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_CommandPopResponse.Merge(m, src)
}
func (m *CommandPopResponse) XXX_Size() int {
	return m.Size()
}
func (m *CommandPopResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_CommandPopResponse.DiscardUnknown(m)
}

var xxx_messageInfo_CommandPopResponse proto.InternalMessageInfo

func (m *CommandPopResponse) GetConsumerId() uint64 {
	if m != nil && m.ConsumerId != nil {
		return *m.ConsumerId
	}
	return 0
...
func (m *CommandPopResponse) GetRestNum() uint64 {
	if m != nil && m.RestNum != nil {
		return *m.RestNum
	}
	return 0
}

func (m *CommandPopResponse) GetResultCode() CommandPopResponse_ResultCode {
	if m != nil && m.ResultCode != nil {
		return *m.ResultCode
	}
	return CommandPopResponse_HAS_MESSAGE
}

func (m *CommandPopResponse) GetMessage() []*CommandMessage {
	if m != nil {
		return m.Message
	}
	return nil
...
func (m *CommandPopResponse) GetPayload() [][]byte {
	if m != nil {
		return m.Payload
	}
	return nil
...
type BaseCommand struct {
	...
	PopRequest                   *CommandPopRequest                   `protobuf:"bytes,198,opt,name=popRequest" json:"popRequest,omitempty"`
	PopResponse                  *CommandPopResponse                  `protobuf:"bytes,199,opt,name=popResponse" json:"popResponse,omitempty"`
	XXX_NoUnkeyedLiteral         struct{}                             `json:"-"`
	XXX_unrecognized             []byte                               `json:"-"`
	XXX_sizecache                int32                                `json:"-"`
}
...
func (m *BaseCommand) GetPopRequest() *CommandPopRequest {
	if m != nil {
		return m.PopRequest
	}
	return nil
...
func (m *BaseCommand) GetPopResponse() *CommandPopResponse {
	if m != nil {
		return m.PopResponse
	}
	return nil
}
...
func init() {
	...
	proto.RegisterEnum("pulsar.proto.CommandPopResponse_ResultCode", CommandPopResponse_ResultCode_name, CommandPopResponse_ResultCode_value)
	...
	proto.RegisterType((*CommandPopRequest)(nil), "pulsar.proto.CommandPopRequest")
	proto.RegisterType((*CommandPopResponse)(nil), "pulsar.proto.CommandPopResponse")
...
var fileDescriptor_39529ba7ad9caeb8 = []byte{
	// 6574 bytes of a gzipped FileDescriptorProto
	,
}
...
func (m *CommandPopRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *CommandPopRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *CommandPopRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if m.PopTimeout == nil {
		return 0, github_com_gogo_protobuf_proto.NewRequiredNotSetError("popTimeout")
	} else {
		i = encodeVarintPulsarApi(dAtA, i, uint64(*m.PopTimeout))
		i--
		dAtA[i] = 0x30
	}
	if m.IsHold == nil {
		return 0, github_com_gogo_protobuf_proto.NewRequiredNotSetError("isHold")
	} else {
		i--
		if *m.IsHold {
			dAtA[i] = 1
	...
	if m.PopStartTime == nil {
		return 0, github_com_gogo_protobuf_proto.NewRequiredNotSetError("popStartTime")
	} else {
		i = encodeVarintPulsarApi(dAtA, i, uint64(*m.PopStartTime))
		i--
		dAtA[i] = 0x20
	}
	if m.InvisibleTime != nil {
		i = encodeVarintPulsarApi(dAtA, i, uint64(*m.InvisibleTime))
		i--
		dAtA[i] = 0x18
	}
	if m.PopNum == nil {
		return 0, github_com_gogo_protobuf_proto.NewRequiredNotSetError("popNum")
	} else {
		i = encodeVarintPulsarApi(dAtA, i, uint64(*m.PopNum))
		i--
		dAtA[i] = 0x10
	}
	if m.ConsumerId == nil {
...
func (m *CommandPopResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *CommandPopResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *CommandPopResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if len(m.Payload) > 0 {
		for iNdEx := len(m.Payload) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = encodeVarintPulsarApi(dAtA, i, uint64(len(m.Payload[iNdEx])))
			i--
			dAtA[i] = 0x2a
		}
	}
	...
	if m.ResultCode == nil {
		return 0, github_com_gogo_protobuf_proto.NewRequiredNotSetError("resultCode")
	} else {
		i = encodeVarintPulsarApi(dAtA, i, uint64(*m.ResultCode))
		i--
		dAtA[i] = 0x18
	}
	if m.RestNum == nil {
		return 0, github_com_gogo_protobuf_proto.NewRequiredNotSetError("restNum")
	} else {
		i = encodeVarintPulsarApi(dAtA, i, uint64(*m.RestNum))
		i--
		dAtA[i] = 0x10
	}
	if m.ConsumerId == nil {
...
func (m *BaseCommand) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.PopResponse != nil {
		{
			size, err := m.PopResponse.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
	...
	if m.PopRequest != nil {
		{
			size, err := m.PopRequest.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *CommandPopRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	...
	if m.PopNum != nil {
		n += 1 + sovPulsarApi(uint64(*m.PopNum))
	}
	if m.InvisibleTime != nil {
		n += 1 + sovPulsarApi(uint64(*m.InvisibleTime))
	}
	if m.PopStartTime != nil {
		n += 1 + sovPulsarApi(uint64(*m.PopStartTime))
	}
	if m.IsHold != nil {
		n += 2
	}
	if m.PopTimeout != nil {
		n += 1 + sovPulsarApi(uint64(*m.PopTimeout))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
...
func (m *CommandPopResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	...
	if m.RestNum != nil {
		n += 1 + sovPulsarApi(uint64(*m.RestNum))
	}
	if m.ResultCode != nil {
		n += 1 + sovPulsarApi(uint64(*m.ResultCode))
	}
	if len(m.Message) > 0 {
...
func (m *CommandPopRequest) Unmarshal(dAtA []byte) error {
	var hasFields [1]uint64
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: CommandPopRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: CommandPopRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
		...
		case 3:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field InvisibleTime", wireType)
			}
			var v uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
		...
		case 4:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field PopStartTime", wireType)
			}
			var v uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
		...
		case 5:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field IsHold", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
		...
		case 6:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field PopTimeout", wireType)
			}
			var v uint32
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
	...
	if hasFields[0]&uint64(0x00000002) == 0 {
		return github_com_gogo_protobuf_proto.NewRequiredNotSetError("popNum")
	}
	if hasFields[0]&uint64(0x00000004) == 0 {
		return github_com_gogo_protobuf_proto.NewRequiredNotSetError("popStartTime")
	}
	if hasFields[0]&uint64(0x00000008) == 0 {
		return github_com_gogo_protobuf_proto.NewRequiredNotSetError("isHold")
	}
	if hasFields[0]&uint64(0x00000010) == 0 {
		return github_com_gogo_protobuf_proto.NewRequiredNotSetError("popTimeout")
	}
...
func (m *CommandPopResponse) Unmarshal(dAtA []byte) error {
	var hasFields [1]uint64
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: CommandPopResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: CommandPopResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
		...
		case 2:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field RestNum", wireType)
			}
			var v uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
		...
		case 3:
			...
			var v CommandPopResponse_ResultCode
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowPulsarApi
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				v |= CommandPopResponse_ResultCode(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		...
		case 4:
			...
			m.Message = append(m.Message, &CommandMessage{})
	...
	if hasFields[0]&uint64(0x00000002) == 0 {
		return github_com_gogo_protobuf_proto.NewRequiredNotSetError("restNum")
	}
	if hasFields[0]&uint64(0x00000004) == 0 {
		return github_com_gogo_protobuf_proto.NewRequiredNotSetError("resultCode")
	}
...
func (m *BaseCommand) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 198:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field PopRequest", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.PopRequest == nil {
				m.PopRequest = &CommandPopRequest{}
			}
			if err := m.PopRequest.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 199:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field PopResponse", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.PopResponse == nil {
				m.PopResponse = &CommandPopResponse{}
			}
			if err := m.PopResponse.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
